...
[![Python versions](https://img.shields.io/pypi/pyversions/remind-cli.svg)](https://pypi.org/project/remind-cli/)
...
```bash
git clone [https://github.com/your-username/remind.git](https://github.com/your-username/remind.git)
cd remind
pip install -e .
```
...
Let me know if you want to tweak any specific terminology or if you're ready to hit publish on PyPI!